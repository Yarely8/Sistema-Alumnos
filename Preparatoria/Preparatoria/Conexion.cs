...
namespace Preparatoria
{
    class Conexion
    {
        string _connectionString = "Data Source=YARELY\\SQLEXPRESS;Initial Catalog=AlumnosP;Integrated Security=True";
        SqlConnection oCon;
        SqlCommand oCmd; 
      SqlDataAdapter oAdapter;
        ...
        public DataTable ObtenerDatosTodos(string StoreProcedure, List<SqlParameter> parametros)
        {
            oTable = new DataTable();
            try
            {
